...
$(document).ready(function() {
	...
	$("#addProductModalBtn").unbind('click').bind('click', function() {
		...
		$("#submitProductForm").unbind('submit').bind('submit', function() {
			...
			if(productType == "") {
				$("#productType").after('<p class="text-danger">Product Type field is required</p>');
			...
			if(productImage && productName && quantity && rate && brandName && categoryName && productStatus && productType) {
		...
		$.ajax({
		  ...
		  // 		allowedFileExtensions: ["jpg", "png", "gif", "JPG", "PNG", "GIF"]
				...
				$("#editProductForm").unbind('submit').bind('submit', function() {
					...
					if(productType == "") {
						$("#editProductType").after('<p class="text-danger">Product Type field is required</p>');
					...
					if(productName && quantity && rate && brandName && categoryName && productStatus && productType) {
						// submit loading button
