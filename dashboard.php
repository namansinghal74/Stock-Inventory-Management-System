...
$userwisesql = "SELECT orders.client_name as username, SUM(orders.grand_total) as totalorder FROM orders WHERE orders.order_status = 1 GROUP BY orders.client_name";
